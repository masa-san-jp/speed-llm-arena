...
通常の26枚Speed対戦によるランキングです。各モデルをはしご方式で対戦させ、対戦結果による順位とEloを併記しています（順位はElo順ではありません）。詳しい条件と正本データは[ランキング詳細](rankings/mbp-m4-max-128gb.md)と[JSON](rankings/mbp-m4-max-128gb.json)を参照してください。

| 順位 | モデル | 戦績 | Elo | 平均応答 |
|---:|---|---:|---:|---:|
| 1 | `qwen3.8:27b` | 2勝 0敗 2分 | 1029.9 | 2979.947ms |
| 2 | `qwen2.5:0.5b` | 1勝 1敗 0分 | 1000.7 | 432.87ms |
| 3 | `gemma4:26b` | 0勝 2敗 2分 | 969.5 | 908.537ms |
| 4 | `gemma4:e4b` | 1勝 0敗 2分 | 1016.0 | 1119.761ms |
| 5 | `gpt-oss:20b` | 0勝 1敗 2分 | 984.0 | 1127.932ms |
